    ...
    [supported_ped.mp_f_freemode_01] = {
        [component.teef] = {
            [supported_weapons.weapon_pistol_mk2] = {
                ...
                construct_equipment(145, 146),
                construct_equipment(147, 148),
                construct_equipment(149, 150),
                construct_equipment(151, 152),
                construct_equipment(153, 154),
                construct_equipment(155, 156),
                construct_equipment(157, 158),
                construct_equipment(159, 160),
                construct_equipment(161, 162),
                construct_equipment(163, 164),
                construct_equipment(165, 166),
                construct_equipment(167, 168),
                construct_equipment(169, 170),
                construct_equipment(171, 172),
                construct_equipment(173, 174),
                construct_equipment(175, 176)
            },
